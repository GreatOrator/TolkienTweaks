...
public class LockableDoubleChestContainer extends AbstractContainerMenu {
    public final LockableDoubleChestBlockEntity tileEntity;
    ...
    public LockableDoubleChestContainer(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()));
    }

    public LockableDoubleChestContainer(int pContainerId, Inventory inv, BlockEntity blockEntity) {
        super(TolkienContainers.LOCKABLE_DOUBLE_CHEST_CONTAINER.get(), pContainerId);
        this.level = inv.player.level();
        this.tileEntity = ((LockableDoubleChestBlockEntity) blockEntity);
