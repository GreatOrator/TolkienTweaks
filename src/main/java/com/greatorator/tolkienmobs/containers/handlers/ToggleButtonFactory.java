...
public class ToggleButtonFactory {
    ...
    private static final List<TextureLocalization> REDSTONE_TEXTURES = List.of(
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/redstoneignore.png"), Component.translatable("justdirethings.screen.ignored")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/redstonelow.png"), Component.translatable("justdirethings.screen.low")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/redstonehigh.png"), Component.translatable("justdirethings.screen.high")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/redstonepulse.png"), Component.translatable("justdirethings.screen.pulse"))
    );
    ...
    private static final List<TextureLocalization> PUSH_PULL_FLUIDS_TEXTURES = List.of(
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/pullfluids.png"), Component.translatable("justdirethings.screen.pullfluids")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/pushfluids.png"), Component.translatable("justdirethings.screen.pushfluids"))
    );
    ...
    private static final ResourceLocation STORE_EXP_BUTTON = ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/add.png");
    ...
    private static final ResourceLocation OWNER_ONLY_BUTTON = ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/player.png");
    ...
    private static final ResourceLocation COLLECT_EXP_BUTTON = ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/mindfog.png");
    ...
    private static final ResourceLocation RESPECTPICKUP_BUTTON = ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/jumpboost.png");
    ...
    private static final ResourceLocation FILTER_ONLY = ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/allowlisttrue.png");
    ...
    private static final ResourceLocation COMPARE_NBT = ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/matchnbttrue.png");
    ...
    private static final ResourceLocation COMPARE_COUNTS = ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/equals.png");
    ...
    private static final ResourceLocation RENDER_AREA = ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/area.png");
    ...
    private static final ResourceLocation RENDER_PARADOX = ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/showfakeplayer.png");
    private static final Component RENDER_PARADOX_LOCALIZATION = Component.translatable("justdirethings.screen.render-paradox");
    ...
    private static final List<TextureLocalization> DIRECTION_TEXTURES = List.of(
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/direction-down.png"), Component.translatable("justdirethings.screen.direction-down")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/direction-up.png"), Component.translatable("justdirethings.screen.direction-up")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/direction-north.png"), Component.translatable("justdirethings.screen.direction-north")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/direction-south.png"), Component.translatable("justdirethings.screen.direction-south")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/direction-west.png"), Component.translatable("justdirethings.screen.direction-west")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/direction-east.png"), Component.translatable("justdirethings.screen.direction-east"))
    );
    ...
    private static final List<TextureLocalization> DIRECTION_NONE_TEXTURES = List.of(
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/direction-none.png"), Component.translatable("justdirethings.screen.direction-none")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/direction-down.png"), Component.translatable("justdirethings.screen.direction-down")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/direction-up.png"), Component.translatable("justdirethings.screen.direction-up")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/direction-north.png"), Component.translatable("justdirethings.screen.direction-north")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/direction-south.png"), Component.translatable("justdirethings.screen.direction-south")),
    ...
    private static final List<TextureLocalization> FILTERBLOCKITEM_TEXTURES = List.of(
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/filter-block.png"), Component.translatable("justdirethings.screen.filter-block")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/filter-item.png"), Component.translatable("justdirethings.screen.filter-item"))
    );
    ...
    private static final List<TextureLocalization> HAMMER_TEXTURES = List.of(
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/ignore.png"), Component.translatable("justdirethings.ability.hammer_off")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/hammer3.png"), Component.translatable("justdirethings.ability.hammer_3")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/hammer5.png"), Component.translatable("justdirethings.ability.hammer_5")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/hammer7.png"), Component.translatable("justdirethings.ability.hammer_7"))
    );
    ...
    private static final List<TextureLocalization> LEFT_RIGHT_CLICK_TEXTURES = List.of(
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/click-right.png"), Component.translatable("justdirethings.screen.click-right")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/click-left.png"), Component.translatable("justdirethings.screen.click-left")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/click-hold.png"), Component.translatable("justdirethings.screen.click-hold"))
    );
    ...
    private static final List<TextureLocalization> CLICK_TARGET_TEXTURES = List.of(
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/filter-block.png"), Component.translatable("justdirethings.screen.target-block")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/filter-air.png"), Component.translatable("justdirethings.screen.target-air")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/mobscanner.png"), Component.translatable("justdirethings.screen.target-hostile")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/passivemob.png"), Component.translatable("justdirethings.screen.target-passive")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/passivemob-adult.png"), Component.translatable("justdirethings.screen.target-adult")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/passivemob-child.png"), Component.translatable("justdirethings.screen.target-child")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/player.png"), Component.translatable("justdirethings.screen.target-player")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/glowing.png"), Component.translatable("justdirethings.screen.target-living"))
    );
    ...
    /** Sneak Click button **/
    private static final ResourceLocation SNEAK_BUTTON = ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/click-sneak.png");
    ...
    private static final ResourceLocation SHOWFAKEPLAYER_BUTTON = ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/showfakeplayer.png");
    ...
    private static final List<TextureLocalization> SENSOR_TARGET_TEXTURES = List.of(
            ...
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/player.png"), Component.translatable("justdirethings.screen.target-player")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/glowing.png"), Component.translatable("justdirethings.screen.target-living")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/item.png"), Component.translatable("justdirethings.screen.target-item"))
    );
    ...
    private static final List<TextureLocalization> PARADOX_TARGET_TEXTURES = List.of(
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/target-both.png"), Component.translatable("justdirethings.screen.paradoxall")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/filter-block.png"), Component.translatable("justdirethings.screen.paradoxblock")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/passivemob.png"), Component.translatable("justdirethings.screen.paradoxentity"))
    );
    ...
    private static final List<TextureLocalization> STRONG_WEAK_REDSTONE_TEXTURES = List.of(
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/redstonelow.png"), Component.translatable("justdirethings.screen.redstone-weak")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/redstonehigh.png"), Component.translatable("justdirethings.screen.redstone-strong"))
    );
    ...
    private static final List<TextureLocalization> EQUALITY_TEXTURES = List.of(
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/greaterthan.png"), Component.translatable("justdirethings.screen.greaterthan")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/lessthan.png"), Component.translatable("justdirethings.screen.lessthan")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/equals.png"), Component.translatable("justdirethings.screen.equals"))
    );
    ...
    private static final ResourceLocation SHOW_PARTICLES_BUTTON = ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/showfakeplayer.png");
    ...
    private static final List<TextureLocalization> SWAPPER_ENTITY_TEXTURES = List.of(
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/entity-none.png"), Component.translatable("justdirethings.screen.entity-none")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/mobscanner.png"), Component.translatable("justdirethings.screen.target-hostile")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/passivemob.png"), Component.translatable("justdirethings.screen.target-passive")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/passivemob-adult.png"), Component.translatable("justdirethings.screen.target-adult")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/passivemob-child.png"), Component.translatable("justdirethings.screen.target-child")),
            ...
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/glowing.png"), Component.translatable("justdirethings.screen.target-living")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/item.png"), Component.translatable("justdirethings.screen.target-item")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/entity-all.png"), Component.translatable("justdirethings.screen.entity-all"))
    );
    ...
    private static final List<TextureLocalization> SWAPPER_BLOCK_TEXTURES = List.of(
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/filter-block.png"), Component.translatable("justdirethings.screen.target-block")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/filter-air.png"), Component.translatable("justdirethings.screen.target-noblock"))
    );
    ...
    private static final List<TextureLocalization> LEFT_RIGHT_ONLY_CLICK_TEXTURES = List.of(
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/click-right.png"), Component.translatable("justdirethings.screen.click-right")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/click-left.png"), Component.translatable("justdirethings.screen.click-left")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/click-sneak.png"), Component.translatable("justdirethings.screen.click-custom"))
    );
    ...
    /** Bind Hotkey button **/
    private static final ResourceLocation BIND_BUTTON = ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/click-hold.png");
    ...
    private static final List<TextureLocalization> REQUIRE_EQUIPPED_TEXTURES = List.of(
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/requireequipped.png"), Component.translatable("justdirethings.screen.requireequipped")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/notreequireequipped.png"), Component.translatable("justdirethings.screen.notrequireequipped"))
    );
    ...
    private static final List<TextureLocalization> HOMING_TARGET_TEXTURES = List.of(
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/mobscanner.png"), Component.translatable("justdirethings.screen.target-hostile")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/entity-all.png"), Component.translatable("justdirethings.screen.target-living"))
    );
    ...
    private static final List<TextureLocalization> HIDE_RENDER_BUTTON = List.of(
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/showfakeplayer.png"), Component.translatable("justdirethings.screen.showrender")),
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/decoy.png"), Component.translatable("justdirethings.screen.hiderender"))
    );
    ...
    private static final List<TextureLocalization> SNAPSHOT_AREA_BUTTON = List.of(
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/positionswap.png"), Component.translatable("justdirethings.screen.snapshotarea"))
    );
    ...
    private static final List<TextureLocalization> SEND_INV_BUTTON = List.of(
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/senditems.png"), Component.translatable("justdirethings.screen.senditems"))
    );
    ...
    private static final List<TextureLocalization> PULL_INV_BUTTON = List.of(
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/pullitems.png"), Component.translatable("justdirethings.screen.pullitems"))
    );
    ...
    private static final List<TextureLocalization> SWAP_INV_BUTTON = List.of(
            new TextureLocalization(ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/swapitems.png"), Component.translatable("justdirethings.screen.swapitems"))
    );
    ...
    private static final ResourceLocation COPY_AREA_BUTTON = ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/area.png");
    ...
    private static final ResourceLocation COPY_OFFSET_BUTTON = ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/stepheight.png");
    ...
    private static final ResourceLocation COPY_FILTER_BUTTON = ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/matchnbttrue.png");
    ...
    private static final ResourceLocation COPY_REDSTONE_BUTTON = ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/buttons/redstonepulse.png");
