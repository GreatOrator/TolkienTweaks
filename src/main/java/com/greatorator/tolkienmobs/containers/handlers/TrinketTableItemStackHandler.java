...
public class TrinketTableItemStackHandler extends ItemStackHandler {
  ...
  public TrinketTableItemStackHandler(int size) {
    super(size);
   ...
   * @return itself
   */
  public TrinketTableItemStackHandler setInputFilter(BiPredicate<ItemStack, Integer> predicate)
  {
   ...
   * @return itself
   */
  public TrinketTableItemStackHandler setOutputFilter(BiPredicate<ItemStack, Integer> predicate)
  {
   ...
   * @return itself
   */
  public TrinketTableItemStackHandler setOnSlotChanged(BiConsumer<ItemStack, Integer> onSlotChanged)
  {
   ...
   * @return itself
   */
  public TrinketTableItemStackHandler setSlotLimit(int slot, int limit)
  {
   ...
   * @return itself
   */
  public TrinketTableItemStackHandler setSlotLimit(int limit)
  {
