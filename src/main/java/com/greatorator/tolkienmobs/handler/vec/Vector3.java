...
public class Vector3 implements Copyable<Vector3> {
    ...
    public BlockPos pos() {
        return new BlockPos(MathUtility.floor(x), MathUtility.floor(y), MathUtility.floor(z));
    }
    ...
    public Vector3 floor() {
        x = MathUtility.floor(x);
        y = MathUtility.floor(y);
        z = MathUtility.floor(z);
        return this;
    }

    public Vector3 ceil() {
        x = MathUtility.ceil(x);
        y = MathUtility.ceil(y);
        z = MathUtility.ceil(z);
        return this;
    }
    ...
    public Vector3 YZintercept(Vector3 end, double px) {
        ...
        double d = (px - x) / dx;
        if (MathUtility.between(-1E-5, d, 1E-5)) {
            return this;
        }

        if (!MathUtility.between(0, d, 1)) {
            return null;
        }
    ...
    public boolean equalsT(Vector3 v) {
        return MathUtility.between(x - 1E-5, v.x, x + 1E-5) && MathUtility.between(y - 1E-5, v.y, y + 1E-5) && MathUtility.between(z - 1E-5, v.z, z + 1E-5);
    }
