...
public class ColorUtility {
    ...
    /**
     * Attempt to parse the string as a color. Maybe either a common CSS color name or a hex code
     ...
     * creating a TolkienColor object. Maybe either a common CSS color name or a hex code with optional
     * leading '#' or '0x'.
     *
     * @param str The string to try to parse
     * @return A TolkienColor object based on str
    ...
    public static int blend(int color1, int color2, float ratio) {
        ratio = MathUtility.clamp(ratio, 0f, 1f);
