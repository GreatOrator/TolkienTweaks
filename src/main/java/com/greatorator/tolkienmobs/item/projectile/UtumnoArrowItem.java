...
public class UtumnoArrowItem extends TolkienArrowItem {
    public UtumnoArrowItem(Properties properties) {
        super(properties);
    }
    ...
    @Override public Projectile asProjectile(Level level, Position pos, ItemStack stack, Direction direction) {
        AbstractArrow arrow = new UtumnoArrowEntity(level, pos.x(), pos.y(), pos.z(), stack.copyWithCount(1), null);
        arrow.pickup = AbstractArrow.Pickup.ALLOWED;
        return arrow;
    }
    @Override public int getBaseDamage() {return 20;}
}
