...
public class CulumaldaBoatItem extends Item {
    private static final Predicate<Entity> ENTITY_PREDICATE = EntitySelector.NO_SPECTATORS.and(Entity::isPickable);
    private final String WOOD_TYPE;
    private final boolean hasChest;

    public CulumaldaBoatItem(boolean hasChest, Properties properties, WoodType woodType) {
        super(properties);
    ...
    private Boat getBoat(Level level, HitResult hitResult) {
        return this.hasChest ? new CulumaldaChestBoatEntity(level, hitResult.getLocation().x, hitResult.getLocation().y, hitResult.getLocation().z, WOOD_TYPE) : new CulumaldaBoatEntity(level, hitResult.getLocation().x, hitResult.getLocation().y, hitResult.getLocation().z, WOOD_TYPE);
    }
}
