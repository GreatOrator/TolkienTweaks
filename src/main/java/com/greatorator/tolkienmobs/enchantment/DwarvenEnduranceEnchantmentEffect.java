...
public record DwarvenEnduranceEnchantmentEffect(int level) implements EnchantmentEntityEffect {
    public static final MapCodec<DwarvenEnduranceEnchantmentEffect> CODEC = RecordCodecBuilder.mapCodec(instance ->
            instance.group(Codec.INT.fieldOf("level").forGetter(DwarvenEnduranceEnchantmentEffect::level))
