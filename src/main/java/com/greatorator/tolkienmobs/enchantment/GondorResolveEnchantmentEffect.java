...
public record GondorResolveEnchantmentEffect(int level) implements EnchantmentEntityEffect {
    public static final MapCodec<GondorResolveEnchantmentEffect> CODEC = RecordCodecBuilder.mapCodec(instance ->
            instance.group(Codec.INT.fieldOf("level").forGetter(GondorResolveEnchantmentEffect::level))
