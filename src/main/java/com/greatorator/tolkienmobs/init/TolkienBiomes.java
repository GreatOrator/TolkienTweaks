...
//        context.register(DAGORLAD, makeBiomeDagorland(dagorladAmbientBuilder().skyColor(getSkyColorWithTemperatureModifier(2.0F)).waterColor(0).fogColor(12638463).foliageColorOverride(2329).grassColorOverride(2329), dagorladSpawning(), dagorladGen(featureGetter, carverGetter)).hasPrecipitation(false).temperature(2.0F).downfall(0.0F).build());
//        context.register(SHIRE, makeBiomeShire(shireAmbientBuilder().skyColor(getSkyColorWithTemperatureModifier(0.8F)).waterColor(14745540).fogColor(5988193).foliageColorOverride(6316071).grassColorModifier(BiomeSpecialEffects.GrassColorModifier.SWAMP), shireSpawning(), shireGen(featureGetter, carverGetter)).hasPrecipitation(true).temperature(0.9F).downfall(0.8F).build());
//        context.register(HARADWAITH, makeBiomeHaradwaith(haradwaithAmbientBuilder().skyColor(getSkyColorWithTemperatureModifier(0.6F)).waterColor(0).fogColor(5988193).foliageColorOverride(738353).grassColorOverride(738353), haradwaithSpawning(), haradwaithGen(featureGetter, carverGetter)).hasPrecipitation(true).temperature(0.25F).downfall(0.8F).build());
//        context.register(GLADDEN, makeBiomeGladden(gladdenAmbientBuilder().skyColor(getSkyColorWithTemperatureModifier(2.0F)).waterColor(0).fogColor(12638463).foliageColorOverride(2329).grassColorOverride(2329), gladdenSpawning(), gladdenGen(featureGetter, carverGetter)).hasPrecipitation(false).temperature(2.0F).downfall(0.0F).build());
//        context.register(FIRIEN, makeBiomeFirien(forestParticles(firienAmbientBuilder()).skyColor(getSkyColorWithTemperatureModifier(0.8F)).waterColor(14745540).fogColor(5988193).foliageColorOverride(6316071).grassColorModifier(BiomeSpecialEffects.GrassColorModifier.SWAMP), firienSpawning(), firienGen(featureGetter, carverGetter)).hasPrecipitation(true).temperature(0.9F).downfall(0.8F).build());
//        context.register(HITHAEGLIR, makeBiomeHithaelgir(hithaeglirAmbientBuilder().skyColor(getSkyColorWithTemperatureModifier(0.6F)).waterColor(0).fogColor(5988193).foliageColorOverride(738353).grassColorOverride(738353), hithaeglirSpawning(), hithaeglirGen(featureGetter, carverGetter)).hasPrecipitation(true).temperature(0.25F).downfall(0.8F).build());
//        context.register(IRON_HILLS, makeBiomeIronHills(ironHillsAmbientBuilder().skyColor(getSkyColorWithTemperatureModifier(0.8F)).waterColor(0x00D2FB).fogColor(0x5B5F61).foliageColorOverride(0x4EAD4E).grassColorOverride(0x4EAD4E), ironHillsSpawning(), ironHillsGen(featureGetter, carverGetter)).hasPrecipitation(true).temperature(0.7F).downfall(0.8F).build());
