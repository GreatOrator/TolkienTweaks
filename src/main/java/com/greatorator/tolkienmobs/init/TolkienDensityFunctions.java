...
import com.greatorator.tolkienmobs.world.components.chunkgenerators.NoiseDensityRouter;
import com.greatorator.tolkienmobs.world.components.chunkgenerators.SqrtDensityFunction;
import com.greatorator.tolkienmobs.world.components.chunkgenerators.TerrainDensityRouter;
...
public class TolkienDensityFunctions {
    ...
    public static final ResourceKey<DensityFunction> BIOME_TERRAIN_RAW = ResourceKey.create(Registries.DENSITY_FUNCTION, TolkienMobsMain.prefix("raw_biome_terrain"));
    public static final ResourceKey<DensityFunction> BIOME_NOISE_RAW = ResourceKey.create(Registries.DENSITY_FUNCTION, TolkienMobsMain.prefix("raw_biome_noise"));
    public static final ResourceKey<DensityFunction> FORESTED_TERRAIN = ResourceKey.create(Registries.DENSITY_FUNCTION, TolkienMobsMain.prefix("forested_terrain"));
    public static final ResourceKey<DensityFunction> SKYLIGHT_TERRAIN = ResourceKey.create(Registries.DENSITY_FUNCTION, TolkienMobsMain.prefix("skylight_terrain"));
    ...
    public static void bootstrap(BootstrapContext<DensityFunction> context) {
        Holder.Reference<BiomeDensitySource> biomeGrid = context.lookup(TolkienBiomes.Keys.BIOME_TERRAIN_DATA).getOrThrow(TolkienLayerStack.BIOME_GRID);
