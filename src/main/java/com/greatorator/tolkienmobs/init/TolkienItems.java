...
public class TolkienItems {
    ...
    public static final DeferredItem<Item> RING_OF_HOPE = ITEMS.register("ring_of_hope", () -> new TolkienItem(new Item.Properties().stacksTo(1)).setEffectOverride().setHasLore());
