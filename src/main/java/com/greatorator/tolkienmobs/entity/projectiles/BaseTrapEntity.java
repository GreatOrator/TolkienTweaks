...
public abstract class BaseTrapEntity extends Entity implements GeoEntity {
    ...
    public BaseTrapEntity(EntityType<? extends BaseTrapEntity> entityTypeIn, Level worldIn) {
                ...
                if (!list.isEmpty()) {
                    for (Entity entity : list) {
                        if (entity instanceof LivingEntity && this.canTrapEntity(((LivingEntity) entity))) {
                            ...
                            if (this.owner != null && this.owner instanceof Mob && ((Mob) this.owner).getTarget() != null && ((Mob) this.owner).getTarget().isAlive() && ((Mob) this.owner).getTarget() == entity && this.owner instanceof TrapsTarget) {
                                ((TrapsTarget) this.owner).setTargetTrapped(true, true);
                            }
