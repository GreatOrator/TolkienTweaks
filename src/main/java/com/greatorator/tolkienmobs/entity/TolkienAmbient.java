...
public class TolkienAmbient extends Animal {
    public final AnimationState idleAnimationState = new AnimationState();
    private int idleAnimationTimeout = 0;
    private static final EntityDataAccessor<Integer> VARIANT =
            SynchedEntityData.defineId(TolkienAmbient.class, EntityDataSerializers.INT);

    public TolkienAmbient(EntityType<? extends Animal> entityType, Level level) {
