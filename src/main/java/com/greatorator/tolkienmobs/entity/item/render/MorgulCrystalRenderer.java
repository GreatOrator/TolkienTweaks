...
public class MorgulCrystalRenderer extends EntityRenderer<MorgulCrystalEntity> {
   private static final ResourceLocation MORGUL_CRYSTAL_LOCATION = ResourceLocation.fromNamespaceAndPath(MODID, "textures/entity/morgul_crystal/morgul_crystal.png");
   ...
   public void render(MorgulCrystalEntity crystalEntity, float entityYaw, float partialTicks, PoseStack stack, MultiBufferSource bufferSource, int p_225623_6_) {
      stack.pushPose();
      float f = getY(crystalEntity, partialTicks);
      float f1 = ((float)crystalEntity.time + partialTicks) * 3.0F;
      ...
      stack.mulPose(new Quaternionf().setAngleAxis((float) (Math.PI / 3), SIN_45, 0.0F, SIN_45));
...
//         FellBeastRender.renderCrystalBeams(-f6, -f7 + f, -f8, p_225623_3_, crystalEntity.time, stack, bufferSource, p_225623_6_);
      ...
      super.render(crystalEntity, entityYaw, partialTicks, stack, bufferSource, p_225623_6_);
   }
