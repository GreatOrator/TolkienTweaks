...
public class OathBreakerEntity extends TolkienMonsterEntity implements GeoEntity {
    private static final EntityDataAccessor<Boolean> ATTACKING =
            SynchedEntityData.defineId(OathBreakerEntity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Integer> VARIANT =
            SynchedEntityData.defineId(OathBreakerEntity.class, EntityDataSerializers.INT);

    public OathBreakerEntity(EntityType<? extends Monster> entityType, Level level) {
