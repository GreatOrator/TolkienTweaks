...
public class MordorOrcEntity extends TolkienMonsterEntity implements GeoEntity {
    private static final EntityDataAccessor<Boolean> ATTACKING =
            SynchedEntityData.defineId(MordorOrcEntity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Integer> VARIANT =
            SynchedEntityData.defineId(MordorOrcEntity.class, EntityDataSerializers.INT);

    public MordorOrcEntity(EntityType<? extends Monster> entityType, Level level) {
    ...
    protected SoundEvent getAmbientSound() {
        return TolkienSounds.IDLE_ORC.get();
    }
}