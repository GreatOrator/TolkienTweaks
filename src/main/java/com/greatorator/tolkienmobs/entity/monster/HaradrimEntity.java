...
public class HaradrimEntity extends TolkienMonsterEntity implements GeoEntity {
    private static final EntityDataAccessor<Boolean> ATTACKING =
            SynchedEntityData.defineId(HaradrimEntity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Integer> VARIANT =
            SynchedEntityData.defineId(HaradrimEntity.class, EntityDataSerializers.INT);

    public HaradrimEntity(EntityType<? extends Monster> entityType, Level level) {
    ...
    protected SoundEvent getAmbientSound() {
        return TolkienSounds.IDLE_OATH_BREAKER.get();
    }
