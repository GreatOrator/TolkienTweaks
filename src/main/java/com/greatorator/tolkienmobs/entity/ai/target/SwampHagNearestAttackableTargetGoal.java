...
public class SwampHagNearestAttackableTargetGoal<T extends LivingEntity> extends NearestAttackableTargetGoal<T> {
   ...
   public SwampHagNearestAttackableTargetGoal(TolkienMonsterEntity raider, Class<T> target, int interval, boolean p_26079_, boolean p_26080_, @Nullable Predicate<LivingEntity> predicate) {
