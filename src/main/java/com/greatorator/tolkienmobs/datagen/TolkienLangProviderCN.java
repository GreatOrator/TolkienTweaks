...
public class TolkienLangProviderCN extends TolkienLangHelper {
    ...
    protected void addTranslations() {
        this.add("itemgroup.tolkienmobs.deco", "托尔金工艺：建筑方块");
            ...
            this.addItem(TolkienItems.MUMAKIL_LEATHER, "猛犸兽皮");
            this.addItem(TolkienItems.MONSTER_FUR, "怪物毛皮");
            this.addItem(TolkienItems.BOTTLE_FANCY, "精美瓶子");
            this.addItem(TolkienItems.FOOD_HONEY, "蜂蜜瓶");
            this.addItem(TolkienItems.MONSTER_FLESH, "怪物肉");
            ...
            this.addItemWithLore(TolkienItems.ITEM_BACKPACK_UPGRADE_SIZE.get(), "背包升级 - Size - Level 1", "Increase the storage capacity of your backpack (+27 Slots, Max-1)");
            this.addItemWithLore(TolkienItems.ITEM_BACKPACK_UPGRADE_SIZE_2.get(), "背包升级 - Size - Level 2", "Further increase backpack storage (+27 Slots, Max-1)");
            this.addItemWithLore(TolkienItems.ITEM_BACKPACK_UPGRADE_FLUID.get(), "背包升级 - Fluid Storage - Level 1", "Allows the carrying of 8 buckets of fluid (Max-1)");
            this.addItemWithLore(TolkienItems.ITEM_BACKPACK_UPGRADE_FLUID_2.get(), "背包升级 - Fluid Storage - Level 2", "Allows the carrying of 16 buckets of fluid (Max-1)");
            this.addItemWithLore(TolkienItems.ITEM_BACKPACK_UPGRADE_FLUID_3.get(), "背包升级 - Fluid Storage - Level 3", "Allows the carrying of 32 buckets of fluid (Max-1)");
            this.addItemWithLore(TolkienItems.ITEM_BACKPACK_UPGRADE_FLUID_4.get(), "背包升级 - Fluid Storage - Level 4", "Allows the carrying of 128 buckets of fluid (Max-1)");
            this.addItemWithLore(TolkienItems.ITEM_BACKPACK_UPGRADE_FLUID_5.get(), "背包升级 - Fluid Storage - Level 5", "Allows fluid stored to be infinite (Max-1)");
            this.addItemWithLore(TolkienItems.ITEM_BACKPACK_UPGRADE_CRAFTING.get(), "背包升级 - Crafting", "Allows crating anywhere (Max-1)");
            this.addItemWithLore(TolkienItems.ITEM_BACKPACK_UPGRADE_SLEEPING.get(), "背包升级 - Sleeping Bag", "Carry around a sleeping bag (Max-1)");
            this.addItemWithLore(TolkienItems.ITEM_BACKPACK_UPGRADE_CAMPFIRE.get(), "背包升级 - Campfire", "Quick use campfire (Max-1)");
        ...
        this.createWoodSet("mallorn", "Mallorn");
            ...
            this.createStoneSet("mossy_dwarven_stone_bricks", "Mossy Dwarven Cobblestone");
            this.createStoneSet("mossy_cobbled_dwarven_stone", "Mossy Dwarven Stone Bricks");
            ...
            this.createStoneSet("mossy_cobbled_dark_stone", "Mossy Cobbled Dark Stone");
            this.createStoneSet("mossy_dark_stone_bricks", "Mossy Dark Stone Bricks");
            ...
            this.createStoneSet("mossy_cobbled_mountain_stone", "Mossy Mountain Cobblestone");
            this.createStoneSet("mossy_mountain_stone_bricks", "Mossy Mountain Stone Bricks");
            ...
            this.createStoneSet("mossy_elven_marble_bricks", "Mossy Elven Marble Bricks");
            this.createStoneSet("smooth_elven_marble", "Smooth Elven Marble");
            this.createStoneSet("mossy_cobbled_elven_marble", "Mossy Cobbled Elven Marble");
            this.createStoneSet("iron_stone", "Iron Hills Stone");
            this.createStoneSet("chiseled_iron_stone_bricks", "Chiseled Iron Hills Stone Bricks");
            this.createStoneSet("cobbled_iron_stone", "Cobbled Iron Hills Stone");
            this.createStoneSet("cracked_iron_stone_bricks", "Cracked Iron Hills Stone");
            this.createStoneSet("iron_stone_bricks", "Iron Hills Stone Bricks");
