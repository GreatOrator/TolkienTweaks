...
public class TolkienBlockStateProvider extends BlockModelBuilders {
    ...
    protected void registerStatesAndModels() {
        ...
        sign(TolkienBlocks.MALLORN_SIGN, TolkienBlocks.MALLORN_WALL_SIGN, "planks_mallorn");
        hangingSign(TolkienBlocks.MALLORN_HANGING_SIGN, TolkienBlocks.MALLORN_HANGING_WALL_SIGN, "stripped_log_mallorn");
        ...
        singleBlockBoilerPlate(TolkienBlocks.HARDENED_LEAVES_MIRKWOOD.get(), "block/leaves", m -> m.texture("all", "block/leaves_mirkwood"));
        ...
        sign(TolkienBlocks.MIRKWOOD_SIGN, TolkienBlocks.MIRKWOOD_WALL_SIGN, "planks_mirkwood");
        hangingSign(TolkienBlocks.MIRKWOOD_HANGING_SIGN, TolkienBlocks.MIRKWOOD_HANGING_WALL_SIGN, "stripped_log_mirkwood");
        ...
        sign(TolkienBlocks.CULUMALDA_SIGN, TolkienBlocks.CULUMALDA_WALL_SIGN, "planks_culumalda");
        hangingSign(TolkienBlocks.CULUMALDA_HANGING_SIGN, TolkienBlocks.CULUMALDA_HANGING_WALL_SIGN, "stripped_log_culumalda");
        ...
        sign(TolkienBlocks.LEBETHRON_SIGN, TolkienBlocks.LEBETHRON_WALL_SIGN, "planks_lebethron");
        hangingSign(TolkienBlocks.LEBETHRON_HANGING_SIGN, TolkienBlocks.LEBETHRON_HANGING_WALL_SIGN, "stripped_log_lebethron");
        ...
        sign(TolkienBlocks.FANGORNOAK_SIGN, TolkienBlocks.FANGORNOAK_WALL_SIGN, "planks_fangornoak");
        hangingSign(TolkienBlocks.FANGORNOAK_HANGING_SIGN, TolkienBlocks.FANGORNOAK_HANGING_WALL_SIGN, "stripped_log_fangornoak");
        ...
        sign(TolkienBlocks.DEADWOOD_SIGN, TolkienBlocks.DEADWOOD_WALL_SIGN, "planks_deadwood");
        hangingSign(TolkienBlocks.DEADWOOD_HANGING_SIGN, TolkienBlocks.DEADWOOD_HANGING_WALL_SIGN, "stripped_log_deadwood");
        ...
        sign(TolkienBlocks.DWARVEN_MAPLE_SIGN, TolkienBlocks.DWARVEN_MAPLE_WALL_SIGN, "planks_dwarven_maple");
        hangingSign(TolkienBlocks.DWARVEN_MAPLE_HANGING_SIGN, TolkienBlocks.DWARVEN_MAPLE_HANGING_WALL_SIGN, "stripped_log_dwarven_maple");
        ...
        blockItem(TolkienBlocks.PRESSURE_PLATE_MOSSY_COBBLED_IRON_STONE);
            ...
            // Angainor
        blockWithItem(TolkienBlocks.ANGAINOR);
        stairsBlock(((StairBlock) TolkienBlocks.STAIRS_ANGAINOR.get()), blockTexture(TolkienBlocks.ANGAINOR.get()));
        slabBlock(((SlabBlock) TolkienBlocks.SLAB_ANGAINOR.get()), blockTexture(TolkienBlocks.ANGAINOR.get()), blockTexture(TolkienBlocks.ANGAINOR.get()));
        pressurePlateBlock(((PressurePlateBlock) TolkienBlocks.PRESSURE_PLATE_ANGAINOR.get()), blockTexture(TolkienBlocks.ANGAINOR.get()));
        buttonBlock(((ButtonBlock) TolkienBlocks.ANGAINOR_BUTTON.get()), blockTexture(TolkienBlocks.ANGAINOR.get()));
        wallBlock(((WallBlock) TolkienBlocks.WALL_ANGAINOR.get()), blockTexture(TolkienBlocks.ANGAINOR.get()));
        blockWithItem(TolkienBlocks.CHISELED_ANGAINOR_BRICKS);
        stairsBlock(((StairBlock) TolkienBlocks.STAIRS_CHISELED_ANGAINOR_BRICKS.get()), blockTexture(TolkienBlocks.CHISELED_ANGAINOR_BRICKS.get()));
        slabBlock(((SlabBlock) TolkienBlocks.SLAB_CHISELED_ANGAINOR_BRICKS.get()), blockTexture(TolkienBlocks.CHISELED_ANGAINOR_BRICKS.get()), blockTexture(TolkienBlocks.CHISELED_ANGAINOR_BRICKS.get()));
        pressurePlateBlock(((PressurePlateBlock) TolkienBlocks.PRESSURE_PLATE_CHISELED_ANGAINOR_BRICKS.get()), blockTexture(TolkienBlocks.CHISELED_ANGAINOR_BRICKS.get()));
        buttonBlock(((ButtonBlock) TolkienBlocks.CHISELED_ANGAINOR_BRICKS_BUTTON.get()), blockTexture(TolkienBlocks.CHISELED_ANGAINOR_BRICKS.get()));
        wallBlock(((WallBlock) TolkienBlocks.WALL_CHISELED_ANGAINOR_BRICKS.get()), blockTexture(TolkienBlocks.CHISELED_ANGAINOR_BRICKS.get()));
        blockWithItem(TolkienBlocks.COBBLED_ANGAINOR);
        stairsBlock(((StairBlock) TolkienBlocks.STAIRS_COBBLED_ANGAINOR.get()), blockTexture(TolkienBlocks.COBBLED_ANGAINOR.get()));
        slabBlock(((SlabBlock) TolkienBlocks.SLAB_COBBLED_ANGAINOR.get()), blockTexture(TolkienBlocks.COBBLED_ANGAINOR.get()), blockTexture(TolkienBlocks.COBBLED_ANGAINOR.get()));
        pressurePlateBlock(((PressurePlateBlock) TolkienBlocks.PRESSURE_PLATE_COBBLED_ANGAINOR.get()), blockTexture(TolkienBlocks.COBBLED_ANGAINOR.get()));
        buttonBlock(((ButtonBlock) TolkienBlocks.COBBLED_ANGAINOR_BUTTON.get()), blockTexture(TolkienBlocks.COBBLED_ANGAINOR.get()));
        wallBlock(((WallBlock) TolkienBlocks.WALL_COBBLED_ANGAINOR.get()), blockTexture(TolkienBlocks.COBBLED_ANGAINOR.get()));
        blockWithItem(TolkienBlocks.CRACKED_ANGAINOR_BRICKS);
        stairsBlock(((StairBlock) TolkienBlocks.STAIRS_CRACKED_ANGAINOR_BRICKS.get()), blockTexture(TolkienBlocks.CRACKED_ANGAINOR_BRICKS.get()));
        slabBlock(((SlabBlock) TolkienBlocks.SLAB_CRACKED_ANGAINOR_BRICKS.get()), blockTexture(TolkienBlocks.CRACKED_ANGAINOR_BRICKS.get()), blockTexture(TolkienBlocks.CRACKED_ANGAINOR_BRICKS.get()));
        pressurePlateBlock(((PressurePlateBlock) TolkienBlocks.PRESSURE_PLATE_CRACKED_ANGAINOR_BRICKS.get()), blockTexture(TolkienBlocks.CRACKED_ANGAINOR_BRICKS.get()));
        buttonBlock(((ButtonBlock) TolkienBlocks.CRACKED_ANGAINOR_BRICKS_BUTTON.get()), blockTexture(TolkienBlocks.CRACKED_ANGAINOR_BRICKS.get()));
        wallBlock(((WallBlock) TolkienBlocks.WALL_CRACKED_ANGAINOR_BRICKS.get()), blockTexture(TolkienBlocks.CRACKED_ANGAINOR_BRICKS.get()));
        blockWithItem(TolkienBlocks.ANGAINOR_BRICKS);
        stairsBlock(((StairBlock) TolkienBlocks.STAIRS_ANGAINOR_BRICKS.get()), blockTexture(TolkienBlocks.ANGAINOR_BRICKS.get()));
        slabBlock(((SlabBlock) TolkienBlocks.SLAB_ANGAINOR_BRICKS.get()), blockTexture(TolkienBlocks.ANGAINOR_BRICKS.get()), blockTexture(TolkienBlocks.ANGAINOR_BRICKS.get()));
        pressurePlateBlock(((PressurePlateBlock) TolkienBlocks.PRESSURE_PLATE_ANGAINOR_BRICKS.get()), blockTexture(TolkienBlocks.ANGAINOR_BRICKS.get()));
        buttonBlock(((ButtonBlock) TolkienBlocks.ANGAINOR_BRICKS_BUTTON.get()), blockTexture(TolkienBlocks.ANGAINOR_BRICKS.get()));
        wallBlock(((WallBlock) TolkienBlocks.WALL_ANGAINOR_BRICKS.get()), blockTexture(TolkienBlocks.ANGAINOR_BRICKS.get()));
        blockWithItem(TolkienBlocks.SMOOTH_ANGAINOR);
        stairsBlock(((StairBlock) TolkienBlocks.STAIRS_SMOOTH_ANGAINOR.get()), blockTexture(TolkienBlocks.SMOOTH_ANGAINOR.get()));
        slabBlock(((SlabBlock) TolkienBlocks.SLAB_SMOOTH_ANGAINOR.get()), blockTexture(TolkienBlocks.SMOOTH_ANGAINOR.get()), blockTexture(TolkienBlocks.SMOOTH_ANGAINOR.get()));
        pressurePlateBlock(((PressurePlateBlock) TolkienBlocks.PRESSURE_PLATE_SMOOTH_ANGAINOR.get()), blockTexture(TolkienBlocks.SMOOTH_ANGAINOR.get()));
        buttonBlock(((ButtonBlock) TolkienBlocks.SMOOTH_ANGAINOR_BUTTON.get()), blockTexture(TolkienBlocks.SMOOTH_ANGAINOR.get()));
        wallBlock(((WallBlock) TolkienBlocks.WALL_SMOOTH_ANGAINOR.get()), blockTexture(TolkienBlocks.SMOOTH_ANGAINOR.get()));
        blockWithItem(TolkienBlocks.MOSSY_ANGAINOR_BRICKS);
        stairsBlock(((StairBlock) TolkienBlocks.STAIRS_MOSSY_ANGAINOR_BRICKS.get()), blockTexture(TolkienBlocks.MOSSY_ANGAINOR_BRICKS.get()));
        slabBlock(((SlabBlock) TolkienBlocks.SLAB_MOSSY_ANGAINOR_BRICKS.get()), blockTexture(TolkienBlocks.MOSSY_ANGAINOR_BRICKS.get()), blockTexture(TolkienBlocks.MOSSY_ANGAINOR_BRICKS.get()));
        pressurePlateBlock(((PressurePlateBlock) TolkienBlocks.PRESSURE_PLATE_MOSSY_ANGAINOR_BRICKS.get()), blockTexture(TolkienBlocks.MOSSY_ANGAINOR_BRICKS.get()));
        buttonBlock(((ButtonBlock) TolkienBlocks.MOSSY_ANGAINOR_BRICKS_BUTTON.get()), blockTexture(TolkienBlocks.MOSSY_ANGAINOR_BRICKS.get()));
        wallBlock(((WallBlock) TolkienBlocks.WALL_MOSSY_ANGAINOR_BRICKS.get()), blockTexture(TolkienBlocks.MOSSY_ANGAINOR_BRICKS.get()));
        blockWithItem(TolkienBlocks.MOSSY_COBBLED_ANGAINOR);
        stairsBlock(((StairBlock) TolkienBlocks.STAIRS_MOSSY_COBBLED_ANGAINOR.get()), blockTexture(TolkienBlocks.MOSSY_COBBLED_ANGAINOR.get()));
        slabBlock(((SlabBlock) TolkienBlocks.SLAB_MOSSY_COBBLED_ANGAINOR.get()), blockTexture(TolkienBlocks.MOSSY_COBBLED_ANGAINOR.get()), blockTexture(TolkienBlocks.MOSSY_COBBLED_ANGAINOR.get()));
        pressurePlateBlock(((PressurePlateBlock) TolkienBlocks.PRESSURE_PLATE_MOSSY_COBBLED_ANGAINOR.get()), blockTexture(TolkienBlocks.MOSSY_COBBLED_ANGAINOR.get()));
        buttonBlock(((ButtonBlock) TolkienBlocks.MOSSY_COBBLED_ANGAINOR_BUTTON.get()), blockTexture(TolkienBlocks.MOSSY_COBBLED_ANGAINOR.get()));
        wallBlock(((WallBlock) TolkienBlocks.WALL_MOSSY_COBBLED_ANGAINOR.get()), blockTexture(TolkienBlocks.MOSSY_COBBLED_ANGAINOR.get()));

        blockItem(TolkienBlocks.STAIRS_SMOOTH_ANGAINOR);
        blockItem(TolkienBlocks.SLAB_SMOOTH_ANGAINOR);
        blockItem(TolkienBlocks.PRESSURE_PLATE_SMOOTH_ANGAINOR);
        blockItem(TolkienBlocks.STAIRS_ANGAINOR_BRICKS);
        blockItem(TolkienBlocks.SLAB_ANGAINOR_BRICKS);
        blockItem(TolkienBlocks.PRESSURE_PLATE_ANGAINOR_BRICKS);
        blockItem(TolkienBlocks.STAIRS_CRACKED_ANGAINOR_BRICKS);
        blockItem(TolkienBlocks.SLAB_CRACKED_ANGAINOR_BRICKS);
        blockItem(TolkienBlocks.PRESSURE_PLATE_CRACKED_ANGAINOR_BRICKS);
        blockItem(TolkienBlocks.STAIRS_COBBLED_ANGAINOR);
        blockItem(TolkienBlocks.SLAB_COBBLED_ANGAINOR);
        blockItem(TolkienBlocks.PRESSURE_PLATE_COBBLED_ANGAINOR);
        blockItem(TolkienBlocks.STAIRS_ANGAINOR_BRICKS);
        blockItem(TolkienBlocks.SLAB_ANGAINOR_BRICKS);
        blockItem(TolkienBlocks.PRESSURE_PLATE_ANGAINOR_BRICKS);
        blockItem(TolkienBlocks.STAIRS_CHISELED_ANGAINOR_BRICKS);
        blockItem(TolkienBlocks.SLAB_CHISELED_ANGAINOR_BRICKS);
        blockItem(TolkienBlocks.PRESSURE_PLATE_CHISELED_ANGAINOR_BRICKS);
        blockItem(TolkienBlocks.STAIRS_ANGAINOR);
        blockItem(TolkienBlocks.SLAB_ANGAINOR);
        blockItem(TolkienBlocks.PRESSURE_PLATE_ANGAINOR);
        blockItem(TolkienBlocks.STAIRS_MOSSY_ANGAINOR_BRICKS);
        blockItem(TolkienBlocks.SLAB_MOSSY_ANGAINOR_BRICKS);
        blockItem(TolkienBlocks.PRESSURE_PLATE_MOSSY_ANGAINOR_BRICKS);
        blockItem(TolkienBlocks.STAIRS_MOSSY_COBBLED_ANGAINOR);
        blockItem(TolkienBlocks.SLAB_MOSSY_COBBLED_ANGAINOR);
        blockItem(TolkienBlocks.PRESSURE_PLATE_MOSSY_COBBLED_ANGAINOR);
