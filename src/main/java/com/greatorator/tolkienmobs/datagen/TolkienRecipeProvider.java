...
public class TolkienRecipeProvider extends TolkienRecipeHelper {
    ...
    protected void buildRecipes(RecipeOutput pRecipeOutput) {
        ...
        smeltingList(TolkienBlocks.COBBLED_ANGAINOR, pRecipeOutput, RecipeCategory.BUILDING_BLOCKS, TolkienBlocks.ANGAINOR, 0.25F, 200);
        smeltingList(TolkienBlocks.ANGAINOR, pRecipeOutput, RecipeCategory.BUILDING_BLOCKS, TolkienBlocks.SMOOTH_ANGAINOR, 0.25F, 200);
        ...
        blastingList(TolkienBlocks.COBBLED_ANGAINOR, pRecipeOutput, RecipeCategory.BUILDING_BLOCKS, TolkienBlocks.ANGAINOR, 0.25F, 100);
        blastingList(TolkienBlocks.ANGAINOR, pRecipeOutput, RecipeCategory.BUILDING_BLOCKS, TolkienBlocks.SMOOTH_ANGAINOR, 0.25F, 100);
        ...
        stoneListRecipe(pRecipeOutput, RecipeCategory.BUILDING_BLOCKS, "mossy_cobbled_dark_stone", TolkienBlocks.WALL_MOSSY_COBBLED_DARK_STONE.get(), TolkienBlocks.MOSSY_COBBLED_DARK_STONE_BUTTON.get(), TolkienBlocks.STAIRS_MOSSY_COBBLED_DARK_STONE.get(), TolkienBlocks.MOSSY_COBBLED_DARK_STONE.get(), TolkienBlocks.SLAB_MOSSY_COBBLED_DARK_STONE.get(), TolkienBlocks.PRESSURE_PLATE_MOSSY_COBBLED_DARK_STONE.get());
        stoneListRecipe(pRecipeOutput, RecipeCategory.BUILDING_BLOCKS, "mossy_dark_stone_bricks", TolkienBlocks.WALL_MOSSY_DARK_STONE_BRICKS.get(), TolkienBlocks.MOSSY_DARK_STONE_BRICKS_BUTTON.get(), TolkienBlocks.STAIRS_MOSSY_DARK_STONE_BRICKS.get(), TolkienBlocks.MOSSY_DARK_STONE_BRICKS.get(), TolkienBlocks.SLAB_MOSSY_DARK_STONE_BRICKS.get(), TolkienBlocks.PRESSURE_PLATE_MOSSY_DARK_STONE_BRICKS.get());
        ...
        stoneListRecipe(pRecipeOutput, RecipeCategory.BUILDING_BLOCKS, "mossy_dwarven_stone_bricks", TolkienBlocks.WALL_MOSSY_DWARVEN_STONE_BRICKS.get(), TolkienBlocks.MOSSY_DWARVEN_STONE_BRICKS_BUTTON.get(), TolkienBlocks.STAIRS_MOSSY_DWARVEN_STONE_BRICKS.get(), TolkienBlocks.MOSSY_DWARVEN_STONE_BRICKS.get(), TolkienBlocks.SLAB_MOSSY_DWARVEN_STONE_BRICKS.get(), TolkienBlocks.PRESSURE_PLATE_MOSSY_DWARVEN_STONE_BRICKS.get());
        stoneListRecipe(pRecipeOutput, RecipeCategory.BUILDING_BLOCKS, "mossy_cobbled_dwarven_stone", TolkienBlocks.WALL_MOSSY_COBBLED_DWARVEN_STONE.get(), TolkienBlocks.MOSSY_COBBLED_DWARVEN_STONE_BUTTON.get(), TolkienBlocks.STAIRS_MOSSY_COBBLED_DWARVEN_STONE.get(), TolkienBlocks.MOSSY_COBBLED_DWARVEN_STONE.get(), TolkienBlocks.SLAB_MOSSY_COBBLED_DWARVEN_STONE.get(), TolkienBlocks.PRESSURE_PLATE_MOSSY_COBBLED_DWARVEN_STONE.get());
        ...
        stoneListRecipe(pRecipeOutput, RecipeCategory.BUILDING_BLOCKS, "mossy_cobbled_mountain_stone", TolkienBlocks.WALL_MOSSY_COBBLED_MOUNTAIN_STONE.get(), TolkienBlocks.MOSSY_COBBLED_MOUNTAIN_STONE_BUTTON.get(), TolkienBlocks.STAIRS_MOSSY_COBBLED_MOUNTAIN_STONE.get(), TolkienBlocks.MOSSY_COBBLED_MOUNTAIN_STONE.get(), TolkienBlocks.SLAB_MOSSY_COBBLED_MOUNTAIN_STONE.get(), TolkienBlocks.PRESSURE_PLATE_MOSSY_COBBLED_MOUNTAIN_STONE.get());
        stoneListRecipe(pRecipeOutput, RecipeCategory.BUILDING_BLOCKS, "mossy_mountain_stone_bricks", TolkienBlocks.WALL_MOSSY_MOUNTAIN_STONE_BRICKS.get(), TolkienBlocks.MOSSY_MOUNTAIN_STONE_BRICKS_BUTTON.get(), TolkienBlocks.STAIRS_MOSSY_MOUNTAIN_STONE_BRICKS.get(), TolkienBlocks.MOSSY_MOUNTAIN_STONE_BRICKS.get(), TolkienBlocks.SLAB_MOSSY_MOUNTAIN_STONE_BRICKS.get(), TolkienBlocks.PRESSURE_PLATE_MOSSY_MOUNTAIN_STONE_BRICKS.get());
        ...
        stoneListRecipe(pRecipeOutput, RecipeCategory.BUILDING_BLOCKS, "mossy_elven_marble_bricks", TolkienBlocks.WALL_MOSSY_ELVEN_MARBLE_BRICKS.get(), TolkienBlocks.MOSSY_ELVEN_MARBLE_BRICKS_BUTTON.get(), TolkienBlocks.STAIRS_MOSSY_ELVEN_MARBLE_BRICKS.get(), TolkienBlocks.MOSSY_ELVEN_MARBLE_BRICKS.get(), TolkienBlocks.SLAB_MOSSY_ELVEN_MARBLE_BRICKS.get(), TolkienBlocks.PRESSURE_PLATE_MOSSY_ELVEN_MARBLE_BRICKS.get());
        stoneListRecipe(pRecipeOutput, RecipeCategory.BUILDING_BLOCKS, "mossy_cobbled_elven_marble", TolkienBlocks.WALL_MOSSY_COBBLED_ELVEN_MARBLE.get(), TolkienBlocks.MOSSY_COBBLED_ELVEN_MARBLE_BUTTON.get(), TolkienBlocks.STAIRS_MOSSY_COBBLED_ELVEN_MARBLE.get(), TolkienBlocks.MOSSY_COBBLED_ELVEN_MARBLE.get(), TolkienBlocks.SLAB_MOSSY_COBBLED_ELVEN_MARBLE.get(), TolkienBlocks.PRESSURE_PLATE_MOSSY_COBBLED_ELVEN_MARBLE.get());
        stoneListRecipe(pRecipeOutput, RecipeCategory.BUILDING_BLOCKS, "angainor", TolkienBlocks.WALL_ANGAINOR.get(), TolkienBlocks.ANGAINOR_BUTTON.get(), TolkienBlocks.STAIRS_ANGAINOR.get(), TolkienBlocks.ANGAINOR.get(), TolkienBlocks.SLAB_ANGAINOR.get(), TolkienBlocks.PRESSURE_PLATE_ANGAINOR.get());
        stoneListRecipe(pRecipeOutput, RecipeCategory.BUILDING_BLOCKS, "cobbled_angainor", TolkienBlocks.WALL_COBBLED_ANGAINOR.get(), TolkienBlocks.COBBLED_ANGAINOR_BUTTON.get(), TolkienBlocks.STAIRS_COBBLED_ANGAINOR.get(), TolkienBlocks.COBBLED_ANGAINOR.get(), TolkienBlocks.SLAB_COBBLED_ANGAINOR.get(), TolkienBlocks.PRESSURE_PLATE_COBBLED_ANGAINOR.get());
        stoneListRecipe(pRecipeOutput, RecipeCategory.BUILDING_BLOCKS, "mossy_angainor_bricks", TolkienBlocks.WALL_MOSSY_ANGAINOR_BRICKS.get(), TolkienBlocks.MOSSY_ANGAINOR_BRICKS_BUTTON.get(), TolkienBlocks.STAIRS_MOSSY_ANGAINOR_BRICKS.get(), TolkienBlocks.MOSSY_ANGAINOR_BRICKS.get(), TolkienBlocks.SLAB_MOSSY_ANGAINOR_BRICKS.get(), TolkienBlocks.PRESSURE_PLATE_MOSSY_ANGAINOR_BRICKS.get());
        stoneListRecipe(pRecipeOutput, RecipeCategory.BUILDING_BLOCKS, "mossy_cobbled_angainor", TolkienBlocks.WALL_MOSSY_COBBLED_ANGAINOR.get(), TolkienBlocks.MOSSY_COBBLED_ANGAINOR_BUTTON.get(), TolkienBlocks.STAIRS_MOSSY_COBBLED_ANGAINOR.get(), TolkienBlocks.MOSSY_COBBLED_ANGAINOR.get(), TolkienBlocks.SLAB_MOSSY_COBBLED_ANGAINOR.get(), TolkienBlocks.PRESSURE_PLATE_MOSSY_COBBLED_ANGAINOR.get());
        stoneListRecipe(pRecipeOutput, RecipeCategory.BUILDING_BLOCKS, "smooth_angainor", TolkienBlocks.WALL_SMOOTH_ANGAINOR.get(), TolkienBlocks.SMOOTH_ANGAINOR_BUTTON.get(), TolkienBlocks.STAIRS_SMOOTH_ANGAINOR.get(), TolkienBlocks.SMOOTH_ANGAINOR.get(), TolkienBlocks.SLAB_SMOOTH_ANGAINOR.get(), TolkienBlocks.PRESSURE_PLATE_SMOOTH_ANGAINOR.get());
        stoneListRecipe(pRecipeOutput, RecipeCategory.BUILDING_BLOCKS, "chiseled_angainor_bricks", TolkienBlocks.WALL_CHISELED_ANGAINOR_BRICKS.get(), TolkienBlocks.CHISELED_ANGAINOR_BRICKS_BUTTON.get(), TolkienBlocks.STAIRS_CHISELED_ANGAINOR_BRICKS.get(), TolkienBlocks.CHISELED_ANGAINOR_BRICKS.get(), TolkienBlocks.SLAB_CHISELED_ANGAINOR_BRICKS.get(), TolkienBlocks.PRESSURE_PLATE_CHISELED_ANGAINOR_BRICKS.get());
        stoneListRecipe(pRecipeOutput, RecipeCategory.BUILDING_BLOCKS, "angainor_bricks", TolkienBlocks.WALL_ANGAINOR_BRICKS.get(), TolkienBlocks.ANGAINOR_BRICKS_BUTTON.get(), TolkienBlocks.STAIRS_ANGAINOR_BRICKS.get(), TolkienBlocks.ANGAINOR_BRICKS.get(), TolkienBlocks.SLAB_ANGAINOR_BRICKS.get(), TolkienBlocks.PRESSURE_PLATE_ANGAINOR_BRICKS.get());
        stoneListRecipe(pRecipeOutput, RecipeCategory.BUILDING_BLOCKS, "cracked_angainor_bricks", TolkienBlocks.WALL_CRACKED_ANGAINOR_BRICKS.get(), TolkienBlocks.CRACKED_ANGAINOR_BRICKS_BUTTON.get(), TolkienBlocks.STAIRS_CRACKED_ANGAINOR_BRICKS.get(), TolkienBlocks.CRACKED_ANGAINOR_BRICKS.get(), TolkienBlocks.SLAB_CRACKED_ANGAINOR_BRICKS.get(), TolkienBlocks.PRESSURE_PLATE_CRACKED_ANGAINOR_BRICKS.get());
        stoneListRecipe(pRecipeOutput, RecipeCategory.BUILDING_BLOCKS, "iron_stone", TolkienBlocks.WALL_IRON_STONE.get(), TolkienBlocks.IRON_STONE_BUTTON.get(), TolkienBlocks.STAIRS_IRON_STONE.get(), TolkienBlocks.IRON_STONE.get(), TolkienBlocks.SLAB_IRON_STONE.get(), TolkienBlocks.PRESSURE_PLATE_IRON_STONE.get());
        stoneListRecipe(pRecipeOutput, RecipeCategory.BUILDING_BLOCKS, "cobbled_iron_stone", TolkienBlocks.WALL_COBBLED_IRON_STONE.get(), TolkienBlocks.COBBLED_IRON_STONE_BUTTON.get(), TolkienBlocks.STAIRS_COBBLED_IRON_STONE.get(), TolkienBlocks.COBBLED_IRON_STONE.get(), TolkienBlocks.SLAB_COBBLED_IRON_STONE.get(), TolkienBlocks.PRESSURE_PLATE_COBBLED_IRON_STONE.get());
        stoneListRecipe(pRecipeOutput, RecipeCategory.BUILDING_BLOCKS, "mossy_iron_stone_bricks", TolkienBlocks.WALL_MOSSY_IRON_STONE_BRICKS.get(), TolkienBlocks.MOSSY_IRON_STONE_BRICKS_BUTTON.get(), TolkienBlocks.STAIRS_MOSSY_IRON_STONE_BRICKS.get(), TolkienBlocks.MOSSY_IRON_STONE_BRICKS.get(), TolkienBlocks.SLAB_MOSSY_IRON_STONE_BRICKS.get(), TolkienBlocks.PRESSURE_PLATE_MOSSY_IRON_STONE_BRICKS.get());
        stoneListRecipe(pRecipeOutput, RecipeCategory.BUILDING_BLOCKS, "mossy_cobbled_iron_stone", TolkienBlocks.WALL_MOSSY_COBBLED_IRON_STONE.get(), TolkienBlocks.MOSSY_COBBLED_IRON_STONE_BUTTON.get(), TolkienBlocks.STAIRS_MOSSY_COBBLED_IRON_STONE.get(), TolkienBlocks.MOSSY_COBBLED_IRON_STONE.get(), TolkienBlocks.SLAB_MOSSY_COBBLED_IRON_STONE.get(), TolkienBlocks.PRESSURE_PLATE_MOSSY_COBBLED_IRON_STONE.get());
        stoneListRecipe(pRecipeOutput, RecipeCategory.BUILDING_BLOCKS, "smooth_iron_stone", TolkienBlocks.WALL_SMOOTH_IRON_STONE.get(), TolkienBlocks.SMOOTH_IRON_STONE_BUTTON.get(), TolkienBlocks.STAIRS_SMOOTH_IRON_STONE.get(), TolkienBlocks.SMOOTH_IRON_STONE.get(), TolkienBlocks.SLAB_SMOOTH_IRON_STONE.get(), TolkienBlocks.PRESSURE_PLATE_SMOOTH_IRON_STONE.get());
        stoneListRecipe(pRecipeOutput, RecipeCategory.BUILDING_BLOCKS, "chiseled_iron_stone_bricks", TolkienBlocks.WALL_CHISELED_IRON_STONE_BRICKS.get(), TolkienBlocks.CHISELED_IRON_STONE_BRICKS_BUTTON.get(), TolkienBlocks.STAIRS_CHISELED_IRON_STONE_BRICKS.get(), TolkienBlocks.CHISELED_IRON_STONE_BRICKS.get(), TolkienBlocks.SLAB_CHISELED_IRON_STONE_BRICKS.get(), TolkienBlocks.PRESSURE_PLATE_CHISELED_IRON_STONE_BRICKS.get());
        stoneListRecipe(pRecipeOutput, RecipeCategory.BUILDING_BLOCKS, "iron_stone_bricks", TolkienBlocks.WALL_IRON_STONE_BRICKS.get(), TolkienBlocks.IRON_STONE_BRICKS_BUTTON.get(), TolkienBlocks.STAIRS_IRON_STONE_BRICKS.get(), TolkienBlocks.IRON_STONE_BRICKS.get(), TolkienBlocks.SLAB_IRON_STONE_BRICKS.get(), TolkienBlocks.PRESSURE_PLATE_IRON_STONE_BRICKS.get());
        stoneListRecipe(pRecipeOutput, RecipeCategory.BUILDING_BLOCKS, "cracked_iron_stone_bricks", TolkienBlocks.WALL_CRACKED_IRON_STONE_BRICKS.get(), TolkienBlocks.CRACKED_IRON_STONE_BRICKS_BUTTON.get(), TolkienBlocks.STAIRS_CRACKED_IRON_STONE_BRICKS.get(), TolkienBlocks.CRACKED_IRON_STONE_BRICKS.get(), TolkienBlocks.SLAB_CRACKED_IRON_STONE_BRICKS.get(), TolkienBlocks.PRESSURE_PLATE_CRACKED_IRON_STONE_BRICKS.get());

        mossyRecipe(pRecipeOutput, TolkienBlocks.MOSSY_COBBLED_ELVEN_MARBLE, TolkienBlocks.COBBLED_ELVEN_MARBLE);
        mossyRecipe(pRecipeOutput, TolkienBlocks.MOSSY_ELVEN_MARBLE_BRICKS, TolkienBlocks.ELVEN_MARBLE_BRICKS);
        mossyRecipe(pRecipeOutput, TolkienBlocks.MOSSY_COBBLED_IRON_STONE, TolkienBlocks.COBBLED_IRON_STONE);
        mossyRecipe(pRecipeOutput, TolkienBlocks.MOSSY_IRON_STONE_BRICKS, TolkienBlocks.IRON_STONE_BRICKS);
        mossyRecipe(pRecipeOutput, TolkienBlocks.MOSSY_COBBLED_DARK_STONE, TolkienBlocks.COBBLED_DARK_STONE);
        mossyRecipe(pRecipeOutput, TolkienBlocks.MOSSY_DARK_STONE_BRICKS, TolkienBlocks.DARK_STONE_BRICKS);
        mossyRecipe(pRecipeOutput, TolkienBlocks.MOSSY_COBBLED_DWARVEN_STONE, TolkienBlocks.COBBLED_DWARVEN_STONE);
        mossyRecipe(pRecipeOutput, TolkienBlocks.MOSSY_DWARVEN_STONE_BRICKS, TolkienBlocks.DWARVEN_STONE_BRICKS);
        mossyRecipe(pRecipeOutput, TolkienBlocks.MOSSY_COBBLED_MOUNTAIN_STONE, TolkienBlocks.COBBLED_MOUNTAIN_STONE);
        mossyRecipe(pRecipeOutput, TolkienBlocks.MOSSY_MOUNTAIN_STONE_BRICKS, TolkienBlocks.MOUNTAIN_STONE_BRICKS);
        mossyRecipe(pRecipeOutput, TolkienBlocks.MOSSY_COBBLED_ANGAINOR, TolkienBlocks.COBBLED_ANGAINOR);
        mossyRecipe(pRecipeOutput, TolkienBlocks.MOSSY_ANGAINOR_BRICKS, TolkienBlocks.ANGAINOR_BRICKS);

        metalListRecipe(pRecipeOutput, RecipeCategory.BUILDING_BLOCKS, "mithril", TolkienBlocks.WALL_MITHRIL.get(), TolkienBlocks.DOOR_MITHRIL.get(), TolkienBlocks.TRAPDOOR_MITHRIL.get(), TolkienBlocks.BARREL_MITHRIL, TolkienBlocks.MITHRIL_BUTTON.get(), TolkienBlocks.STAIRS_MITHRIL.get(), TolkienBlocks.BLOCK_MITHRIL.get(), TolkienBlocks.SLAB_MITHRIL.get(), TolkienBlocks.PRESSURE_PLATE_MITHRIL.get(), TolkienBlocks.MITHRIL_BARS, TolkienBlocks.ELVEN_LANTERN, TolkienBlocks.TORCH_MALLORN, TolkienItems.INGOT_MITHRIL.get(), TolkienItems.NUGGET_MITHRIL.get(), TolkienItems.GALADHRIM_ARROW.get());
