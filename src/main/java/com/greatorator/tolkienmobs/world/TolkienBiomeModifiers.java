...
public class TolkienBiomeModifiers {
    public static final ResourceKey<BiomeModifier> ADD_TREE_MIRKWOOD = registerKey("add_tree_mirkwood");
    ...
    public static void bootstrap(BootstrapContext<BiomeModifier> context) {
        ...
        context.register(ADD_TREE_MIRKWOOD, new BiomeModifiers.AddFeaturesBiomeModifier(
                ...
                HolderSet.direct(placedFeatures.getOrThrow(TolkienPlacedFeatures.MIRKWOOD_PLACED_KEY)),
