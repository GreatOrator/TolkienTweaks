...
public class FallenLebethronLeavesFeature extends Feature<NoneFeatureConfiguration> {

	public FallenLebethronLeavesFeature(Codec<NoneFeatureConfiguration> config) {
		super(config);
	}

	private final BlockState state = TolkienBlocks.LEAFPILE_LEBETHRON.get().defaultBlockState();
