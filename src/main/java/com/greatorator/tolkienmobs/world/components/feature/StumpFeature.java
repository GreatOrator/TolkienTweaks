...
public class StumpFeature extends Feature<NoneFeatureConfiguration> {
    ...
    public StumpFeature(Codec<NoneFeatureConfiguration> deserializer)
    {
        super(deserializer);
    }
    ...
    public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> featurePlaceContext) {
        ...
        for (int i = 0; i < height; i++) {
            this.setBlock(world, pos.above(i), TolkienBlocks.LOG_FANGORNOAK.get().defaultBlockState());
        }
    ...
    public static boolean isAir(LevelSimulatedReader simulatedReader, BlockPos blockPos) {
        return simulatedReader.isStateAtPosition(blockPos, BlockBehaviour.BlockStateBase::isAir);
    }
}
