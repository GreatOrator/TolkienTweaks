...
public class SpheroidFoliagePlacer extends FoliagePlacer {
    public static final MapCodec<SpheroidFoliagePlacer> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
    ...
    public static final SpheroidFoliagePlacer NO_OP = new SpheroidFoliagePlacer(0, 0, ConstantInt.of(0), 0, 0, 0.0F, 0);
    ...
    protected FoliagePlacerType<SpheroidFoliagePlacer> type() {
        return TolkienFeatureModifiers.FOLIAGE_SPHEROID.get();
    }
