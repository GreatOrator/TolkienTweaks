...
public class FallenCulumaldaLeavesFeature extends Feature<NoneFeatureConfiguration> {

	public FallenCulumaldaLeavesFeature(Codec<NoneFeatureConfiguration> config) {
		super(config);
	}
