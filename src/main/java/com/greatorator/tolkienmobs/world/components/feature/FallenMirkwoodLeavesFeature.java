...
public class FallenMirkwoodLeavesFeature extends Feature<NoneFeatureConfiguration> {

	public FallenMirkwoodLeavesFeature(Codec<NoneFeatureConfiguration> config) {
		super(config);
	}
