...
public class FallenFangornOakLeavesFeature extends Feature<NoneFeatureConfiguration> {

	public FallenFangornOakLeavesFeature(Codec<NoneFeatureConfiguration> config) {
		super(config);
	}

	private final BlockState state = TolkienBlocks.LEAFPILE_FANGORNOAK.get().defaultBlockState();
