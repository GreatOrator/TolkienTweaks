 ...
 */
public class TolkienTreeFeatureConfig implements FeatureConfiguration {
	public static final Codec<TolkienTreeFeatureConfig> codecTFTreeConfig = RecordCodecBuilder.create(instance -> instance.group(
	...
	).apply(instance, TolkienTreeFeatureConfig::new));
	...
	public TolkienTreeFeatureConfig(BlockStateProvider trunk, BlockStateProvider leaves, BlockStateProvider branch, BlockStateProvider roots, int height, int chanceFiveFirst, int chanceFiveSecond, boolean hasLeaves, boolean checkWater, List<TreeDecorator> decorators) {
	...
	public static class Builder {
		...
		public TolkienTreeFeatureConfig.Builder minHeight(int height) {
			this.baseHeight = height;
			return this;
		}

		public TolkienTreeFeatureConfig.Builder chanceFirstFive(int chance) {
			this.chanceFirstFive = chance;
			return this;
		}

		public TolkienTreeFeatureConfig.Builder chanceSecondFive(int chance) {
			this.chanceSecondFive = chance;
			return this;
		}

		public TolkienTreeFeatureConfig.Builder noLeaves() {
			this.hasLeaves = false;
			return this;
		}

		public TolkienTreeFeatureConfig.Builder checksWater() {
			this.checkWater = true;
			return this;
		}

		public TolkienTreeFeatureConfig.Builder addDecorator(TreeDecorator deco) {
			decorators.add(deco);
			return this;
		}

		public TolkienTreeFeatureConfig build() {
			return new TolkienTreeFeatureConfig(trunkProvider, leavesProvider, branchProvider, rootsProvider, baseHeight, chanceFirstFive, chanceSecondFive, hasLeaves, checkWater, decorators);
		}
	}
}
