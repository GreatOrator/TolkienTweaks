...
public class TolkienSurfaceRuleData
{
    ...
    public static SurfaceRules.RuleSource overworldLike(boolean checkAbovePreliminarySurface, boolean bedrockRoof, boolean bedrockFloor)
    {
        ...
        builder.addAll(TolkienSurfaceRuleManager.getDefaultSurfaceRuleAdditionsForStage(TolkienSurfaceRuleManager.RuleCategory.OVERWORLD, TolkienSurfaceRuleManager.RuleStage.BEFORE_BEDROCK));
        ...
        List<SurfaceRules.RuleSource> afterBedrockRules = TolkienSurfaceRuleManager.getDefaultSurfaceRuleAdditionsForStage(TolkienSurfaceRuleManager.RuleCategory.OVERWORLD, TolkienSurfaceRuleManager.RuleStage.AFTER_BEDROCK);
    ...
    public static SurfaceRules.RuleSource nether()
    {
        ...
        ImmutableList.Builder<SurfaceRules.RuleSource> builder = ImmutableList.builder();
        builder.addAll(TolkienSurfaceRuleManager.getDefaultSurfaceRuleAdditionsForStage(TolkienSurfaceRuleManager.RuleCategory.NETHER, TolkienSurfaceRuleManager.RuleStage.BEFORE_BEDROCK));
        builder.add(bedrockRules);
        builder.addAll(TolkienSurfaceRuleManager.getDefaultSurfaceRuleAdditionsForStage(TolkienSurfaceRuleManager.RuleCategory.NETHER, TolkienSurfaceRuleManager.RuleStage.AFTER_BEDROCK));
