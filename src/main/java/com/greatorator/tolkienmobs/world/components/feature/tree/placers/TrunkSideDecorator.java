package com.greatorator.tolkienmobs.world.components.feature.tree.placers;
...
public class TrunkSideDecorator extends TreeDecorator {
	...
	protected TreeDecoratorType<TrunkSideDecorator> type() {
		return TolkienFeatureModifiers.TRUNKSIDE_DECORATOR.get();
	}
	...
	public void place(Context context) {
		...
		if (blockCount == 0) {
			TolkienMobsMain.LOGGER.error("[TrunkSideDecorator] Trunk Blocks were empty! Why?");
			return;
		}
