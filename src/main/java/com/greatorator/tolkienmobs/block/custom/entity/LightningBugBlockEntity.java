...
public class LightningBugBlockEntity extends TolkienBlockEntity {
	...
	public LightningBugBlockEntity(BlockPos pos, BlockState state) {
		super(TolkienBlocks.LIGHTNINGBUG_BLOCK_ENTITY.get(), pos, state);
	}

	public static void tick(Level level, BlockPos pos, BlockState state, LightningBugBlockEntity te) {
