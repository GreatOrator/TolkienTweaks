...
import com.greatorator.tolkientweaks.handler.interfaces.IEquipmentManager;
...
public class CuriosWrapper implements ICurio {
    ...
    private IEquipmentManager item;

    public CuriosWrapper(ItemStack stack) {
        this.stack = stack;
    }

    @Override
    public void curioTick(String identifier, int index, LivingEntity livingEntity) {
        this.item = (IEquipmentManager) stack.getItem();
