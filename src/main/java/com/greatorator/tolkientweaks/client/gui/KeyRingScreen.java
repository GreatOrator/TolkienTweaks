package com.greatorator.tolkientweaks.client.gui;
...
public class KeyRingScreen extends ModularGuiContainer<KeyRingContainer> {
    ...
    protected GuiToolkit<KeyRingScreen> toolkit = new GuiToolkit<>(this, 176, 166).setTranslationPrefix("gui.tolkientweaks.key_ring");
